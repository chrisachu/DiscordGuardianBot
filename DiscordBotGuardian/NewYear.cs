...
namespace DiscordBotGuardian
{
    public class NewYear
    {
        ...
        public async Task GenerateCategoriesAsync(CommandContext Context, string Event, int Year)
        {
            ...
            // Add default roles
            GuardianEventsReadOnly.Add(new RolePermissions { Role = "Head-Guardian-" + Event + "-" + Year, ChannelPermType = RolePermissions.ChannelPermissions("admin") });
            ...
            await CreateCategory(Context, Event + "-" + Year, new List<RolePermissions> { new RolePermissions { Role = "Guardian-" + Event + "-" + Year, ChannelPermType = RolePermissions.ChannelPermissions("standard") }, new RolePermissions { Role = "Staff", ChannelPermType = RolePermissions.ChannelPermissions("standard") } });
            await CreateCategory(Context, "Command-Center-" + Event + "-" + Year, new List<RolePermissions> { new RolePermissions { Role = "Admin", ChannelPermType = RolePermissions.ChannelPermissions("admin") }, new RolePermissions { Role = "Staff", ChannelPermType = RolePermissions.ChannelPermissions("standard") }, new RolePermissions { Role = "Head-Guardian-" + Event + "-" + Year, ChannelPermType = RolePermissions.ChannelPermissions("admin") }, new RolePermissions { Role = "Team-Lead-" + Event + "-" + Year, ChannelPermType = RolePermissions.ChannelPermissions("standard") }, new RolePermissions { Role = "Guardian-" + Event + "-" + Year, ChannelPermType = RolePermissions.ChannelPermissions("readonly") } });
            await CreateCategory(Context, Event + "-Commons-" + Year, new List<RolePermissions> { new RolePermissions { Role = "Guardian-" + Event + "-" + Year, ChannelPermType = RolePermissions.ChannelPermissions("standard") }, new RolePermissions { Role = "Staff", ChannelPermType = RolePermissions.ChannelPermissions("standard") } });
        ...
        public async Task GenerateChannelsAsync(CommandContext Context, string Event, int Year)
        {
            ...
            await CreateChannel(Context, "community-calendar", GuardianEventsReadOnly, "Announcements for everyone.", "Administration", 7);
            ...
            // Clear out old TOS
            await SentDiscordCommands.DeleteLastMessage(Context, "rulebook");
            // Post new TOS
