...
namespace DiscordBotGuardian
{
    public class RolePermissions
    {
        ...
        public static OverwritePermissions ChannelPermissions(string type)
        {
            ...
            {
                // return inherit
                return new OverwritePermissions(viewChannel: PermValue.Allow, sendMessages: PermValue.Allow, readMessageHistory: PermValue.Allow, connect: PermValue.Allow, speak: PermValue.Allow, addReactions:PermValue.Allow, embedLinks:PermValue.Allow, attachFiles:PermValue.Allow, useExternalEmojis:PermValue.Allow);
            }
        }
        /// <summary>
